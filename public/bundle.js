var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-1w09v3d");
    			add_location(button, file$3, 20, 8, 529);
    			attr_dev(header, "class", "svelte-1w09v3d");
    			add_location(header, file$3, 16, 6, 341);
    			add_location(div, file$3, 22, 6, 608);
    			attr_dev(section, "class", "svelte-1w09v3d");
    			add_location(section, file$3, 15, 2, 324);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text(t_value);
    			attr_dev(button, "class", "highlight svelte-1w09v3d");
    			toggle_class(button, "selected", /*selected*/ ctx[1] === /*tab*/ ctx[6]);
    			add_location(button, file$3, 18, 10, 390);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 27, 0, 705);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(output_1, "class", "svelte-rz5846");
    			add_location(output_1, file$6, 12, 2, 210);
    			attr_dev(textarea, "spellcheck", "false");
    			attr_dev(textarea, "class", "svelte-rz5846");
    			add_location(textarea, file$6, 13, 2, 269);
    			attr_dev(article, "class", "svelte-rz5846");
    ...
    /* components\ErrorBox.svelte generated by Svelte v3.43.1 */
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	let { text = 'Oooops' } = $$props;
    	const writable_props = ['text'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ErrorBox> was created with unknown prop '${key}'`);
    	});
    ...
    const file$8 = "components\\Editor.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(errorbox, section, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	const makepretty = _ => {
    		...
    		pattern.forEach((row, i) => {
    			//Could be imrpoved by using row line number
    			const markOps = (ops, str) => ops.reverse().reduce(
    				(all, op) => {
    					if (op.type === 'repeat') {
    		...
    		$$invalidate(1, input_styled = arr.join(''));
    	};
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$9, 11, 2, 252);
    			add_location(menu, file$9, 14, 2, 327);
    			add_location(main, file$9, 10, 0, 242);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
