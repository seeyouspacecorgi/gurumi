var app = (function () {
    ...
    class View extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { pattern: 0 });
    ...
    const file$5 = "components\\Inputs\\TextArea.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			html_tag.a = br;
    			add_location(br, file$5, 12, 43, 251);
    			attr_dev(output_1, "class", "svelte-1jzljy7");
    			add_location(output_1, file$5, 12, 2, 210);
    			attr_dev(textarea, "spellcheck", "false");
    			attr_dev(textarea, "wrap", "soft");
    			attr_dev(textarea, "class", "svelte-1jzljy7");
    			add_location(textarea, file$5, 13, 2, 269);
    			attr_dev(article, "class", "svelte-1jzljy7");
    			add_location(article, file$5, 11, 0, 197);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class TextArea extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { raw: 0, styled: 1 });
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 11, 2, 252);
    			add_location(menu, file$7, 14, 2, 327);
    			add_location(main, file$7, 10, 0, 242);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
